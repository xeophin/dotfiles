...
# defaults write NSGlobalDomain AppleHighlightColor -string "0.764700 0.976500
# 0.568600"
...
# Default is using the current location, should be good enough
...
# Never use screen saver, use energy saver instead
...
# Use "Date Modified" as default for column view
